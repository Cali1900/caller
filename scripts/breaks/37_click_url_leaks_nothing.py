...
# mailed. A 128-bit token is precisely so it cannot be walked.
#
# Re-anchored after tracked_url gained the empty-base guard.
...
NEW = """    tok = token_for(lead_id)
    return f'{base}/c/{lead_id}' if tok else None"""

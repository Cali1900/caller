...
#
#   ./scripts/scratch_drip.sh new       -> a scratch DRIP, prints its campaign_id
#   ./scripts/scratch_drip.sh new-call  -> a scratch CALL campaign, same idea
...
SQL
  ...
  ;;
*)
  echo "usage: $0 {new|new-call|list|clean}" >&2; exit 2 ;;
esac
